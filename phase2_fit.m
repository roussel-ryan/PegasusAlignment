function [fit,MSE] = phase2_fit(collected_data,axis)
%phase2_fit Get line parameters that fit to the data collected 
%   collected_data in the form of [t1_x t1_y t2_x t2_y centroid_x centroid_y]
%   parameters are fit to the equation z = fit[1] + fit[2]*t2_axis
    if strcmp(axis,'x')
        add_axis = 0;
